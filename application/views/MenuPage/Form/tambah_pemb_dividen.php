          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              <form action="set-pemb-bgh" id="set-pemb-bgh" method="POST" class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-3" >Hasil keuntungan (Rp)</label>
                  <div class="col-md-6 col-sm-6 col-xs-6">
                    <input type="text" required class="form-control" name="jumlah" id="nominal">
                  </div>
                </div> <br>
                <div class="form-group">
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-2">
                    <input type="text" required readonly class="form-control text-center" id="pers-b">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-2">
                    <input type="text" required readonly class="form-control text-center" id="pers-m">
                  </div>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12">
