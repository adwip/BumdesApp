                    ...
                    <form action="set-aset-baru" id="set-aset-baru" method="POST" class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                          <input type="text" required class="form-control" name="nama_aset" id="kontak" value="Excavator">
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-2">
                          <input type="text" readonly class="form-control" name="nama_aset" id="kontak" value="0051578813210">
                        </div>
                      </div> <br>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3" for="penyewa">Nomor aset</label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                          <input type="text" required class="form-control" name="nomor_aset" value="ASET/2019/BELI/MNG">
                        </div>
                      </div><br>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3" for="tang_mul">Lokasi</label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                          <input type="text" required class="form-control" name="lokasi" id="tang_mul" value="Dusun kalipuru, Kebumen">
                        </div>
                      </div> <br>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3" for="kontak">Kondisi</label>
                        <div class="col-md-3 col-sm-3 col-xs-3 text-center">
                          <input checked type="radio" name="kondisi" value="Baru">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                          <input type="text" required class="form-control" name="tanggal_masuk" id="tang_mul" value="20-05-2019">
                        </div>
                      </div> <br>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3" for="kontak">Keadaan</label>
                        <div class="col-md-3 col-sm-3 col-xs-3 text-center">
                          <input checked type="radio" name="keadaan" value="Baik">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3" for="kontak">Kepemilikan</label>
                        <div class="col-md-3 col-sm-3 col-xs-3 text-center">
                          <input checked type="radio" name="keadaan" value="Baik">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                          <textarea name="catatan" class="form-control" name="" id="" cols="30" rows="10" style="resize:none;">Pembelian aset untuk disewakan</textarea>
                        </div>
                      </div> <br>
